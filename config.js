...
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:4949d32e432dfa3ab482c67d473b58ca";
const SUDO = process.env.SUDO || '2349019406102';
...
const STICKER_DATA = process.env.STICKER_DATA || "JAY;KARLY";
